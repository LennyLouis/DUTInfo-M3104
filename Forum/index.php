...
<main id="main">
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;" id="sidebarClose">
        ...
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            <li class="nav-item">
                <a href="#" class="nav-link py-3 border-bottom" title="Home" data-bs-toggle="tooltip"
                   data-bs-placement="right" id="nav-link-home" onclick="changePage('home')">
            ...
            <li>
                <a href="#" class="nav-link py-3 border-bottom" title="Orders" data-bs-toggle="tooltip"
                   data-bs-placement="right" id="nav-link-forum" onclick="changePage('forum')">
        ...
        <div class="dropdown border-top">
            ...
            <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser3">
                <li><h3 class="dropdown-header">Hi <?= $u->getUsername() ?> !</h3></li>
                <li>
                ...
                <li><a class="dropdown-item" href="controller/logout.controller.php">Sign out</a></li>
            </ul>
            <?php } else { ?>
                <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser3">
    ...
    <page-content class="b-example-divider" id="pageContent">
